<template>
    <a-form ref="formRef" :rules="rules" :model="form" @submit="handleSubmit"
        ...
        <a-card title="仓库物流（每单）" style="margin-bottom: 10px">
        ...
        <div class="footer-action">
            <a-space>
                ...
                <a-button type="text" @click="calculateBreakEvenROI">保本ROI为: {{ breakEvenROI }}</a-button>
                <a-button type="text" @click="updateApp">利润率为100: {{ profitMargin }}%</a-button>
            </a-space>
        </div>
    </a-form>
    <!-- {{ form }} -->
